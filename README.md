...
or pasting TTML source. Its combined-copy format also populates the validator's
PID and subtitle URL fields together. Signed URLs must be used before they expire.
